...
// Generated 7 janv. 2015 16:18:42 by Hibernate Tools 3.4.0.CR1
 ...
 * @see com.books.hibernate.Evaluation
...
public class EvaluationHome {
	...
	public Evaluation merge(Evaluation detachedInstance) {
		...
		try {
			Evaluation result = (Evaluation) sessionFactory.getCurrentSession()
	...
	public Evaluation findById(java.lang.Integer id) {
		...
		try {
			Evaluation instance = (Evaluation) sessionFactory
					.getCurrentSession().get("com.books.hibernate.Evaluation",
							id);
			if (instance == null) {
	...
	public List findByExample(Evaluation instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.books.hibernate.Evaluation")
